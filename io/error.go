...
func (e UnsupportedTypeError) Error() string {
	return "hprose/io: unsupported type: " + e.Type.String()
}
...
func (e CastError) Error() string {
	if e.Source == nil {
		return "hprose/io: can not cast nil to " + e.Destination.String()
	}
	if e.Destination == nil {
		return "hprose/io: can not cast " + e.Source.String() + " to nil"
	}
	return "hprose/io: can not cast " + e.Source.String() + " to " + e.Destination.String()
}
